...
static bool bmp_wrqueue_locrib(struct bmp* bmp, struct pullwr* pullwr) {
	...
	case BMP_AFI_SYNC:
		...
		// TODO BMP_MON_LOCRIB check if this is true after implenting LOCRIB syncing
	...
	if (bmp->targets->afimon[afi][safi] & BMP_MON_LOC_RIB) {
		...
		// TODO BMP_MON_LOC_RIB understand this part more, why iterate through the table ?
...
//				continue;
		...
		bmp_monitor(bmp, peer, 5, &bqe->p, prd,
